...
contract("TendCertifier", async accounts => {
  ...
  it("is correctly initialised", async () => {
    ...
    const certified = await tendCertifier.certified.call(admin)
  ...
  it("is owned by admin", async () => {
    ...
    const owner = await tendCertifier.owner.call()
  ...
  it("doesn't allow user1 to certify user2", async () => {
    ...
    const certified = await tendCertifier.certified.call(user2)
  ...
  it("doesn't allow user1 to revoke user2", async () => {
    ...
    const certified = await tendCertifier.certified.call(user1)
